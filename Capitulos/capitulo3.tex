...
O protocolo SPI usa uma topologia mestre-escravo, onde um dispositivo "mestre" se comunica com um ou mais dispositivos "escravos". A comunicação se dá em quatro linhas de sinal (\textit{four wire serial bus}):
...
A Figura \ref{fig:spi1} ilustra a 
