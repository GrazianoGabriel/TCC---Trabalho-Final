%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CAPÍTULO 3
\chapter{O Sistema de Monitoramento de Variações de Tensão de Curta Duração}  
...
\item [-] Disponibilização das informações salvas pelo sistema em um buffer rotativo para consulta  pelo usuário através da interface de comunicação Ethernet.
\end{itemize}  
...
\label{fig:placamedicao} \fonte{Sobrinho (2016)}
\end{figure}
